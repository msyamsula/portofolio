...
// DirectedAcyclicGraph checks if the graph is a DAG and returns topological order
func (s *service) DirectedAcyclicGraph(g *Graph) (path []string, acyclic bool) {
...
func (s *service) kahn(nodes []*Node) {
	queue := nodes
