...
var (
	...
	queryDeleteUnreadMessage = "DELETE FROM unread_messages WHERE conversation_id = :conversation_id RETURNING id, sender_id, receiver_id, conversation_id, data, create_time;"
