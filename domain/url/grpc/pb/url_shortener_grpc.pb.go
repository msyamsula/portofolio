...
const (
	UrlShortener_GetLongUrl_FullMethodName  = "/url_shortener.UrlShortener/GetLongUrl"
	UrlShortener_SetShortUrl_FullMethodName = "/url_shortener.UrlShortener/SetShortUrl"
)
...
type UrlShortenerClient interface {
	...
	SetShortUrl(ctx context.Context, in *UrlRequest, opts ...grpc.CallOption) (*UrlResponse, error)
}
...
func (c *urlShortenerClient) GetLongUrl(ctx context.Context, in *UrlRequest, opts ...grpc.CallOption) (*UrlResponse, error) {
...
func (c *urlShortenerClient) SetShortUrl(ctx context.Context, in *UrlRequest, opts ...grpc.CallOption) (*UrlResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UrlResponse)
	err := c.cc.Invoke(ctx, UrlShortener_SetShortUrl_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UrlShortenerServer interface {
	...
	SetShortUrl(context.Context, *UrlRequest) (*UrlResponse, error)
...
func (UnimplementedUrlShortenerServer) GetLongUrl(context.Context, *UrlRequest) (*UrlResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLongUrl not implemented")
}
func (UnimplementedUrlShortenerServer) SetShortUrl(context.Context, *UrlRequest) (*UrlResponse, error) {
...
func _UrlShortener_GetLongUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UrlShortenerServer).GetLongUrl(ctx, req.(*UrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _UrlShortener_SetShortUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UrlRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UrlShortenerServer).SetShortUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UrlShortener_SetShortUrl_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UrlShortenerServer).SetShortUrl(ctx, req.(*UrlRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UrlShortener_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UrlShortener_SetShortUrl_Handler,
		},
	},
...
const (
	Greeter_SayHello_FullMethodName = "/url_shortener.Greeter/SayHello"
)
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "url_shortener.Greeter",
